                    ...
                    <form action="{{ route('anggota.update', $anggota->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input id="nama_lengkap" name="nama_lengkap" type="text" value="{{ old('nama_lengkap', $anggota->nama_lengkap) }}" class="block w-full mt-1 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required autofocus>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="tipe_anggota" name="tipe_anggota" class="block w-full mt-1 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                    <option value="Mahasiswa" {{ old('tipe_anggota', $anggota->tipe_anggota) == 'Mahasiswa' ? 'selected' : '' }}>Mahasiswa</option>
                                    <option value="Dosen" {{ old('tipe_anggota', $anggota->tipe_anggota) == 'Dosen' ? 'selected' : '' }}>Dosen</option>
                                    <option value="Staff" {{ old('tipe_anggota', $anggota->tipe_anggota) == 'Staff' ? 'selected' : '' }}>Staff</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="status_keanggotaan" name="status_keanggotaan" class="block w-full mt-1 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                    <option value="Aktif" {{ old('status_keanggotaan', $anggota->status_keanggotaan) == 'Aktif' ? 'selected' : '' }}>Aktif</S>
                            ...
                            <div>
                                ...
                                <input id="email" name="email" type="email" value="{{ old('email', $anggota->email) }}" class="block w-full mt-1 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                            </div>
                            ...
                            <div>
                                ...
                                <input id="nomor_telepon" name="nomor_telepon" type="text" value="{{ old('nomor_telepon', $anggota->nomor_telepon) }}" class="block w-full mt-1 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                            </div>

                            {{-- Alamat (Opsional) --}}
                            <div class="md:col-span-2">
                                <label for="alamat" class="block font-medium text-sm text-gray-700 dark:text-gray-300">Alamat (Opsional)</label>
                                <textarea id="alamat" name="alamat" rows="3" class="block w-full mt-1 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('alamat', $anggota->alamat) }}</textarea>
                            </div>
                        </div>
