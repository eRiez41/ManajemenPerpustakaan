                                ...
                                @forelse ($peminjamans as $peminjaman)
                                    <tr>
                                       ...
                                       <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            @if($peminjaman->status == 'Dipinjam')
                                                {{-- TOMBOL KEMBALIKAN (Tambah ml-4) --}}
                                                <form action="{{ route('peminjaman.update', $peminjaman->id) }}" method="POST" class="inline-block ml-4"> {{-- <-- TAMBAH ml-4 di sini --}}
                                                    @csrf
                                                    @method('PUT')
                                                    {{-- Ganti warna tombol jadi hijau biar beda --}}
                                            ...
                                            @else
                                                {{-- TEKS SELESAI (Tambah ml-4) --}}
                                                <span class="text-gray-500 dark:text-gray-400 inline-block ml-4"> {{-- <-- TAMBAH ml-4 di sini --}}
                                                    Selesai
                                                </span>
                                            @endif
                                        </td>
